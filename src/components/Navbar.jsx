...
const Navbar = () => {
  ...
  return (
    <div
      className={`py-5 h-fit flex items-center z-50 fixed bg-[#000000a0] w-full shadow-lg transition-transform duration-300 ${visible ? 'translate-y-0' : '-translate-y-full'}`}
    >
      <motion.div
      ...
      >
        ...
        <div className="flex gap-5">
          {token ? (
            <Link
              to="/userprofile"
              className="px-3 py-3 rounded-full hover:bg-white/20 transition"
            >
              <svg
